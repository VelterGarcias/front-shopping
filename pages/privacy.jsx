...
export default function About() {
    ...
    return (
        ...
        <Layout pageTitle="Valentin Shopping Center" >
            <header className={`${styles.pageHeader} ${styles.privacyHeader}`}>
                <div className={styles.title} >
                    <h1>Política de Privacidade</h1>
                </div>
            </header>
            <section className={styles.privacy}>
                <p>A sua privacidade é importante para nós. É política do Valentin Shopping Center respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href="https://front-shopping.vercel.app">Valentin Shopping Center</a>, e outros sites que possuímos e operamos.</p> 
                ...
                <h2>Política de Cookies Valentin Shopping Center</h2>
                ...
                <p>Como é prática comum em quase todos os sites profissionais, este site usa cookies, que são pequenos arquivos baixados no seu computador, para melhorar sua experiência. Esta página descreve quais informações eles coletam, como as usamos e por que às vezes precisamos armazenar esses cookies. Também compartilharemos como você pode impedir que esses cookies sejam armazenados, no entanto, isso pode fazer o downgrade ou 'quebrar' certos elementos da funcionalidade do site.</p>
                  ...
                  <p>Esta política é efetiva a partir de <strong>Julho de 2020</strong>.</p>
            </section>
